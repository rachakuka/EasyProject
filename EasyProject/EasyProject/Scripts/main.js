...
$(window).on('load', function () {
    ...
    if ($("#ProgramadorPage").length === 1) {
        $("li.active").removeClass("active");
        $("#ProgramadorIndex").parent().addClass("active")
    } 
    else if ($("#ContatoPage").length === 1) {
        $("li.active").removeClass("active")
        $("#ProgramadorContact").parent().addClass("active")
    }
    else if ($("#ListaProgramadorPage").length === 1) {
        $("li.active").removeClass("active")
        $("#ProgramadorLista").parent().addClass("active")
    }
